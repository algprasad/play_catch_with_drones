...
def make_plots(all_logdirs, legend=None, xaxis=None, values=None, count=False,  
               font_scale=1.5, smooth=1, select=None, exclude=None, estimator='mean', fname='baselines.png'):
...
def main():
    ...
    parser.add_argument('--fname', default='baselines.png')
    ...
    make_plots(args.logdir, args.legend, args.xaxis, args.value, args.count, 
               ...
               estimator=args.est, fname=args.fname)
